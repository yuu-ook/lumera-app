...
const S = {
  ...
  dayChip: { minWidth: 38, height: 38, border: "1px solid rgba(255,255,255,0.1)", borderRadius: 1, background: "none", color: "rgba(255,255,255,0.25)", fontSize: 13, cursor: "pointer", flexShrink: 0, transition: "all .2s", fontFamily: "sans-serif" },
  dayChipOn: { background: "rgba(201,169,122,0.12)", color: GOLD, border: `1px solid ${GOLD}` },
